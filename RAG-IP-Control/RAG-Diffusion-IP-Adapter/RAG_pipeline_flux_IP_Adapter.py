...
from cross_attention_IP_Adapter import init_forwards,hook_forwards,TOKENS
...
module_path = './RAG_transformer_flux_IP_Adapter.py'
...
class RAG_FluxPipeline(
    ...
    def prepare_HB_replace(
        self, HB_latents_list, timesteps, HB_replace, latents, HB_prompt_embeds_list, HB_pooled_prompt_embeds_list, HB_text_ids_list, HB_latent_image_ids_list, guidance, HB_m_scale_list, HB_n_scale_list, image_emb_list
    ):
        ...
        for i, t in enumerate(timesteps):
            ...
            for HB_prompt_embeds, HB_latents, HB_pooled_prompt_embeds, HB_text_ids,HB_latent_image_ids, image_emb in zip(HB_prompt_embeds_list, HB_latents_list, HB_pooled_prompt_embeds_list, HB_text_ids_list, HB_latent_image_ids_list, image_emb_list):
                joint_attention_kwargs={"image_emb_list": [image_emb]}
    ...
    def __call__(
        ...
        image_emb_list: List[torch.FloatTensor] = None,
        image_mask_list: List[torch.FloatTensor] = None,
        prompt: Union[str, List[str]] = None,
        ...
        # 6. Denoising loop        
        HB_latents_list_list, HB_hidden_states_list_list_list = self.prepare_HB_replace(HB_latents_list, timesteps, HB_replace, latents, HB_prompt_embeds_list, HB_pooled_prompt_embeds_list, HB_text_ids_list, HB_latent_image_ids_list, guidance, HB_m_scale_list, HB_n_scale_list, image_emb_list)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                self._joint_attention_kwargs = {"SR_encoder_hidden_states_list": SR_prompt_embeds_list, "SR_norm_encoder_hidden_states_list": None, "SR_hidden_states_list": None, "SR_norm_hidden_states_list": None, "image_emb_list": image_emb_list, "image_mask_list": image_mask_list}
